 ...
 * @author huoxianwei
 * @date 2019/5/9 11:13
 * 堆排序：构造大顶堆或小顶堆，交换堆顶和最后一个节点位置，依次循环
 */
public class HeapSort {
    public static void main(String[] args) {
        int[] array = new int[]{6, 1, 9, 3, 10, 5, 8, 7,2};
        // 接下来就是排序的主体逻辑
        sort(array);
    ...
    private static void sort(int[] array) {
        ...
        System.out.println("堆调整结束 "+Arrays.toString(array));
        // 上述逻辑，建堆结束
        // 下面，开始排序逻辑
     ...
     * @param array 数组
     * @param i 下标
     * @param length 需要调整的数组长度（每次堆顶的元素交换到末尾）
     */
    private static void adjustHeap(int[] array, int i, int length) {
        System.out.println("i="+i+"  length="+length+"  array="+Arrays.toString(array));
